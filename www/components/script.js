        ...
        cordova.plugins.barcodeScanner.scan(
            function (result) {
                if(result.text == '280720550'){
                    ...
                    document.getElementById('informacoes').src = "imgs/Imagem4.jpg";
                    ...
                    document.getElementById('informacoes').src = "imgs/Imagem2.jpg";
                    ...
                    document.getElementById('informacoes').src = "imgs/Imagem3.jpg";
                    ...
                    document.getElementById('imagemTri').src = "imgs/Imagem4.jpg";
